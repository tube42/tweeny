...
/*
 * some examples for using TweenHelper to simplify your code
 */
public class Demo6 extends BaseWindow implements ActionListener
{
    ...
    public Demo6()
    {
        setTitle("TweenHelper");
        label.setText("Press a button to start one of TweenHelper operations");
